  ...
  return (
    <div className="md:mx-auto max-w-[800px] my-40">
      <div className="flex justify-between mx-2 rounded-md my-2">
        <Link
          to="/"
          className={`border p-2 min-w-[120px] text-center transition-all delay-100 hover:bg-blue-600 hover:text-white`}
        >
          На главную
        </Link>
        <button
      ...
      >
        ...
        <h1 className="text-gray-700 text-2xl font-bold">Успешное бронирование</h1>
        <p className="text-gray-600 mt-2">
          Благодарим вас за бронирование!
        </p>
        <p className="text-gray-600">
          Пожалуйста, проверьте свою электронную почту для получения информации о бронировании и инструкций по
          вашему пребыванию.
        </p>
