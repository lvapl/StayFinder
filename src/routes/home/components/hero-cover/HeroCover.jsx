...
const HeroCover = (props) => {
  ...
  return (
    <div className="bg-blue-600 min-h-[400px] md:min-h-72 lg:min-h-60 text-slate-100">
      <div className="hero-content__container flex flex-col items-center container mx-auto px-2 md:px-0">
        ...
        <div className="hero-content__text py-4">
          <h3 className="text-4xl font-medium">
            Откройте для себя идеальный отдых по всему миру
          </h3>
          <p className="my-1">
            Введите свои даты, чтобы ознакомиться с последними ценами, и начните свое путешествие
            к отдыху и приключениям уже сегодня.
          </p>
        </div>
        <GlobalSearchBox
