            ...
            <div className="bg-white p-6  md:mx-auto">
              ...
              <div className="text-center">
                <h3 className="md:text-2xl text-base text-gray-700 font-semibold text-center">
                  Было отправлено электронное письмо для восстановления!
                </h3>
                ...
                <div className="my-6  text-center">
                  <Link
                    to="/"
                    className="px-12 bg-blue-600 hover:bg-indigo-500 text-white font-semibold py-3"
                  >
                    ВЕРНУТЬСЯ
                  </Link>
                </div>
              ...
              <div className="text-center mb-10">
                ...
                <div className="mb-6">
                  ...
                  <p className="text-gray-700">
                    Мы вышлем проверочный код на это электронное письмо, если он соответствует
